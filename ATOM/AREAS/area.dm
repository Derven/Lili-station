...
/area
	...
	ship
		...
		deck_1
			...
			soundreturn()
				return pick('rick.ogg', 'ambigen6.ogg', 'ambigen5.ogg', 'ambigen1.ogg','ambigen3.ogg','station4.ogg','ambigen4.ogg','station6.ogg','ambigen9.ogg','ambigen10.ogg','ambigen11.ogg','ambigen12.ogg')
