...
/obj/machinery/computer/rdconsole
					...
					for(var/M in being_built.materials)
						...
						if(being_built.build_path)
							...
							if(being_built.locked)
								var/obj/item/weapon/storage/box/L = new/obj/item/weapon/storage/box(linked_lathe.loc)
								new_item.loc = L
	...
	attack_hand(usr)
		...
		usr << browse("<TITLE>Research and Development Console</TITLE><HR>[dat]", "window=rdconsole;size=575x400")
		onclose(usr, "rdconsole")