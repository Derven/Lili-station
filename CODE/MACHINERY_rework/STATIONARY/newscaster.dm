...
/proc/strip_html(var/t,var/limit=MAX_MESSAGE_LEN)
	return fix1103(sanitize(strip_html_simple(t)))
...
/obj/machinery/newscaster/proc/power_change()
...
/obj/machinery/newscaster/attack_hand(mob/user as mob)
	...
	if(istype(user, /mob/simulated/living/humanoid))
		var/mob/simulated/living/human_or_robot_user = user
		var/dat
...
obj/item/weapon/newspaper/Topic(href, href_list)
	var/mob/simulated/living/U = usr
	..()
...
/obj/machinery/newscaster/proc/scan_user(var/mob/simulated/living/humanoid/user)
	if(istype(user,/mob/simulated/living/humanoid)) //User is a human
		src.scanned_user ="Unknown"
