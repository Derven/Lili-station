...
var/global/list/meta_gas_info = list()
var/global/list/meta_gas_list = list()//see ATMOSPHERICS/gas_types.dm
var/global/list/gaslist_cache = list()
var/global/list/init_gaslist_cache = list()
