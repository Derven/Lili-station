/datum/computer/file/computer_program/arcade
	...
	var/obj/machinery/consol/holder
	var/obj/machinery/consol/master

	New(obj/holding as obj)
		if(holding)
			src.holder = holding

			if(istype(src.holder.loc,/obj/machinery/consol))
...
/datum/computer/file/computer_program/arcade/proc/return_text()
	if(..())
		return
