...
/proc/electrocute_mob(mob/M as mob, var/power_source, var/obj/source, var/siemens_coeff = 1.0)
	...
	if (cell)
		cell_damage = null//cell.get_electrocute_damage()
	//var/shock_damage = 0
	...
	var/drained_hp = null//M.electrocute_act(shock_damage, source, siemens_coeff) //zzzzzzap!
